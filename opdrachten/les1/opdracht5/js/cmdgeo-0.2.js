...
User.prototype = {
    ...
    currentPosition: function() {
        return: geo_position_js.getCurrentPosition(Tour.setPosition, _geo_error_handler, {enableHighAccuracy:true});
    }
}

// Adding methods to Tour Object
Tour.prototype = {
    tourType: tourType,
    locatieRij: markerRij = [],
    init: function() {
        Debugger.message("Controleer of GPS beschikbaar is...");
    ...
    startInterval: function(event) {
        Debugger.message("GPS is beschikbaar, vraag positie.");
        this.updatePosition();
    ...
    setPosition: function(position) {
        ...
        Debugger.message(intervalCounter+" positie lat:"+position.coords.latitude+" long:"+position.coords.longitude);
    },
            ...
            if(this.calculateDistance(locatie, currentPosition)<locaties[i][2]){
                ...
                if(window.location!=locaties[i][1] && localStorage[locaties[i][0]]=="false"){
                    ...
                    try {
                        ...
                        Debugger.message("Localstorage kan niet aangesproken worden: "+error);
                    }

                    // TODO: Animeer de betreffende marker

                    window.location = locaties[i][1];
                    Debugger.message("Speler is binnen een straal van "+ locaties[i][2] +" meter van "+locaties[i][0]);
                }
            }
        }
    },
...
Map.prototype = {
    ...
    generate: function() {
        Debugger.message("Genereer een Google Maps kaart en toon deze in #"+ this.canvasId)
        map = new google.maps.Map(document.getElementById(this.canvasId), this.myOptions);

        var routeList = [];
        // Voeg de markers toe aan de map afhankelijk van het tourtype
        debug_message("Locaties intekenen, tourtype is: "+Tour.tourType);
        for (var i = 0; i < locaties.length; i++) {
    ...
    // TODO: Kleur aanpassen op het huidige punt van de tour
        ...
        ET.addListener(POSITION_UPDATED, Tour.updatePosition);
    }
}

// Adding methods to Debugger Object
Debugger.prototype = {
    ...
    message: function(message) {
        (customDebugging && this.debugId)?document.getElementById(this.debugId).innerHTML:console.log(message);
    },
